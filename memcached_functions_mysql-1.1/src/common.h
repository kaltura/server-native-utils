...
struct memc_function_st {
  memcached_st* memc;					// memcache instance
  unsigned int offset;					// used in increment / decrement
  time_t expiration;					// used in write actions (add/set/...)
  memcached_result_st results;			// get output container
  memcached_string_st *stats_string;	// stats output buffer
};
